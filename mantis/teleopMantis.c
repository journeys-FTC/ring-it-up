...
#pragma config(Motor,  mtr_S1_C1_1,     ballHopper,    tmotorTetrix, openLoop)
#pragma config(Motor,  mtr_S1_C1_2,     hand,          tmotorTetrix, openLoop, reversed)
#pragma config(Motor,  mtr_S1_C2_1,     shoulderJoint, tmotorTetrix, openLoop)
#pragma config(Motor,  mtr_S1_C2_2,     elbowJoint,    tmotorTetrix, openLoop, reversed)
#pragma config(Motor,  mtr_S1_C4_1,     rightSide,     tmotorTetrix, openLoop)
#pragma config(Motor,  mtr_S1_C4_2,     leftSide,      tmotorTetrix, openLoop, reversed)
